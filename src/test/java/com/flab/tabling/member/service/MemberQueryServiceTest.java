...
class MemberQueryServiceTest {
	...
	void findByEmailSuccess() {
		...
		//when
		Member result = memberQueryService.findByEncryptedEmail(encryptEmail);
	...
	void findByEmailFailure() {
		...
		//when, then
		assertThrows(MemberNotFoundException.class, () -> memberQueryService.findByEncryptedEmail(encryptEmail));
	}
	...
	void checkSellerSuccessReturnTrue() {
		...
		//when
		boolean result = memberQueryService.isSeller(1L);
	...
	public void checkEmailDuplicatedFailure() {
		...
		//when, then
		assertThrows(MemberDuplicatedException.class, () -> memberQueryService.checkEmailDuplicated(encryptedEmail));
	}
}
