...
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (1, '관리자', '$2a$10$ZfjDzRbZgEIzQcijDwS0v.8XcMxwVmVU7twnkjpJqGzX8MjqBYTAC', '$2a$10$NGg5NhI4uHS1WFDl92QakONnG5s6nbVj8jKL5t1OTmkjcceL7TZXm', 'ROLE_ADMIN', '2023-09-17', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (2, '식당사장A', '$2a$10$8LBlz0VBco/iJaPQ4fCd.OXDN0PL45MaQMFEMSm52tErlP08AO5Ey', '$2a$10$0Jp1lNstfC2C2WfoDoJox.Qsk5v1zySXCHts6AlvYealUKswGiP1y', 'ROLE_STORE', '2023-09-18', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (3, '식당사장B', '$2a$10$aK0B/nk2X54YwFcfFQP4UOCfjqkC.HYXoeJ9Q7u.a7xfkmiqXTmMe', '$2a$10$u5orIwBDxTXNrFdcYnbC0OLJbAQl2gwsypbMUhC3sec4bghhvcJa2', 'ROLE_STORE', '2023-09-19', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (4, '일반사용자A', '$2a$10$62ciJVk8M.pkWhY.Wg93ourJGQUJYLR.HZ9FhhZwdjaB4/lIcAzYG', '$2a$10$mZHX5D/rR.MIebDlDwsrz.PhQic60ClnqaCC.yn/g0WUE.oW7SBFu', 'ROLE_CUSTOMER', '2023-09-19', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (5, '일반사용자B', '$2a$10$9jMwfm1VrV1ZhRLjwaUiy.7YJbDkqXcLdm5pinKhvbtjdFbKvQ99i', '$2a$10$s.Llje0qHdj3HI3/NggnvuN0k5ua2at80.h7q.jtI.uTUZY.DhhCC', 'ROLE_CUSTOMER', '2023-09-19', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (6, '일반사용자C', '$2a$10$.rpLS7LeaNG3U1tfx8ble.EVy72AVbbjdkfN63rwyifr5fyJoP/ea', '$2a$10$jgxvYu4Qs5BeBRfBkRVUzeI3tnozZbZAv3KUaoyPOenJN4zajePSS', 'ROLE_CUSTOMER', '2023-09-20', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (7, '일반사용자D', '$2a$10$PRrVaDyflXeR/kB1L.zAheEXHpQ.ybyb0wWasV6sK9Kp.NfJ8Ak6S', '$2a$10$6d0ln9fIVTQljT7PAjvNh.3.82AP5bmtEKiggzJNKCGuzBthicbPO', 'ROLE_CUSTOMER', '2023-09-20', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (8, '일반사용자E', '$2a$10$6LVfRXnFgD40otvXD5v5DeUYR21KaE38G1uj4Fmbyty391Prun1mu', '$2a$10$Ff48rwa/BfGZvNfVlIML1uFxeldF5X13ZMnlY8QaJ0D87n0M5JR0G', 'ROLE_CUSTOMER', '2023-09-20', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (9, '일반사용자F', '$2a$10$HNCm9XsZav7dWrDc3XQmRelhHxLNXgAnGRq2ZgUo/9U.Q.jVO7vbe', '$2a$10$kfpWXBHEAcC5hJrj3K6NvutQK9QTCCHKgn4g7wokcz4TUVGjiOuZ2', 'ROLE_CUSTOMER', '2023-09-20', null, null, null);
INSERT
    INTO member
        (id, name, email, password, role_type, created_at, modified_at, created_by, modified_by)
            VALUES (10, '일반사용자G', '$2a$10$V1nmXxqvSXzRPWZ9iMJweuLFTQ4iyqwMMrz73Q4DocOD2Xf9DMYgS', '$2a$10$cOhTOagX5Q9/Jdf7hRWxJOjicBm1JCHUnvURqG26GwyXmrTF99e8O', 'ROLE_CUSTOMER', '2023-09-21', null, null, null);
...
INSERT
    INTO address
        (id, store_id, area1, area2, area3, land_name, land_number1, land_number2, created_at, modified_at, created_by, modified_by)
...
INSERT
    INTO history
        (id, table_name, record_id, operation_type, snapshot, created_at, modified_at, created_by, modified_by)
            VALUES (1, 'favorite', 7, 'BACKUP', '{"id":1, "store_id":2, "member_id":9, "created_at":"2023-09-23", "modified_at":null, "created_by":null, "modified_by":null}', '2023-09-22', null, null, null);
