...
public class StoreCrudController {
	...
	public ResponseEntity<StoreFindDto.Response> find(@PathVariable(name = "id") Long storeId) {
		StoreFindDto.Response storeFindResponse = storeQueryService.find(storeId);
	...
	public ResponseEntity<Page<StoreFindDto.Response>> findPage(
		...
		Page<StoreFindDto.Response> storeFindResponsePages = storeQueryService.findPage(pageable);
		return ResponseEntity.status(HttpStatus.OK)
